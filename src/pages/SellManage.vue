...
<router-link to="/sell/manage/add"><el-button  class="add" type="primary" :icon="Edit">新增</el-button></router-link>
...
export default {
  ...
  methods:{
    handleEdit:function(row){
      window.location.href=`/sell/manage/edit/${row}`
    },
