...
<router-link to="/stock/manage/add"><el-button  class="add" type="primary" :icon="Edit">新增</el-button></router-link>
<el-table :data="tableData" border style="width: 100%">
    ...
    <el-table-column prop="name" label="名称" />
     <el-table-column  label="图片" >
      ...
      <el-table-column prop="people" label="进货人" />
      <el-table-column prop="time" label="进货日期" />
...
export default {
  ...
  methods:{
    handleEdit:function(row){
      window.location.href=`/stock/manage/edit/${row}`
    },
    ...
    handleReset:function(){
      this.formInline={No:'',name:'',time:new Date()};
    }
  },
  mounted:function(){
    this.total = stockInfo.length;
  }
}
</script>
