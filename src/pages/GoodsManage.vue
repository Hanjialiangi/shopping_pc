  ...
  <h3>商品管理</h3>
   <el-form :inline="true" :model="formInline" class="demo-form-inline">
    <el-form-item label="编号">
      <el-input v-model="formInline.isbn" placeholder="请输入编号" />
    </el-form-item>
...
<router-link to="/goods/manage/add"><el-button  class="add" type="primary" :icon="Edit">新增</el-button></router-link>
<el-table :data="tableData" border style="width: 100%">
    <el-table-column prop="isbn" label="编号"/>
...
export default {
  ...
  methods:{
    handleEdit:function(row){
      window.location.href=`/goods/manage/edit/${row}`
    },
    ...
    handleReset:function(){
      this.formInline={isbn:'',name:''};
    }
  },
  mounted:function(){
    this.total = GoodsInfo.length;
  }
}
</script>
